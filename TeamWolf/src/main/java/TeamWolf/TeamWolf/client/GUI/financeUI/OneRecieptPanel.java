...
public class OneRecieptPanel extends JPanel{
	...
	FinanceApplicationService service = ReceiptPanel.service;
	...
	private void setNext(){
		...
		if((giftNum+2)*Hgap>panelD.height){
			panelD.setSize(FinanceFrame.width-20, (giftNum+4)*Hgap);
		}
	}
	...
	private void removeLast(){
		...
		if((giftNum+4)*Hgap<panelD.height){
			panelD.setSize(FinanceFrame.width-20, (giftNum+1)*Hgap);
		}
